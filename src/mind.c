...
#else
{
	"Detects visible monsters in your vicinity and more and more. Detects traps and doors at level 5, invisible monsters at level 15, items at level 30. And magic mapping at level 20. Lights and reveals the whole level at level 45. Gives telepathy at level 25.",
	...
	"Stops time. Consumes all of your SP. The duration of the spell increases as more SP is consumed.",
	"",
	"",
	"",
	"",
