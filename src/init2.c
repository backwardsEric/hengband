			...
			void **info, char **name, char **text)
{
	...
	if (err)
	{
		...
		/* Error */
#ifdef JP
		if (err) quit(format("'%s_j.raw'¥Õ¥¡¥¤¥ë¤ò²òÀÏ¤Ç¤­¤Þ¤»¤ó¡£", filename));
#else
...
static void init_angband_aux(cptr why)
{
	...
	/* More details */
	plog("¤Ò¤ç¤Ã¤È¤¹¤ë¤È¥¢¡¼¥«¥¤¥Ö¤¬Àµ¤·¤¯²òÅà¤µ¤ì¤Æ¤¤¤Ê¤¤¤Î¤«¤â¤·¤ì¤Þ¤»¤ó¡£");
...
void init_angband(void)
{
	...
	/* Initialize misc. values */
#ifdef JP
note("[ÊÑ¿ô¤ò½é´ü²½¤·¤Æ¤¤¤Þ¤¹...(¤½¤ÎÂ¾)");
#else
	note("[Initializing values... (misc)]");
#endif

#ifdef JP
if (init_misc()) quit("¤½¤ÎÂ¾¤ÎÊÑ¿ô¤ò½é´ü²½¤Ç¤­¤Þ¤»¤ó");
#else
	...
	if (init_s_info()) quit("½ÏÎýÅÙ½é´ü²½ÉÔÇ½");
#else
...
#ifdef JP
note("[ÇÛÎó¤ò½é´ü²½¤·¤Æ¤¤¤Þ¤¹... (·úÊª)]");
#else
	note("[Initializing arrays... (buildings)]");
#endif

#ifdef JP
if (init_buildings()) quit("·úÊª¤ò½é´ü²½¤Ç¤­¤Þ¤»¤ó");
#else
